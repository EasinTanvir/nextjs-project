...
const Profile = ({ visible, name, image, email }: ProfileProps) => (
  <div
    className={`${
        ...
        {!visible && (
          <>
            <div className="ml-4 mr-4">
              <div className="base2 font-semibold text-n-1">{name}</div>
              <div className="caption1 font-semibold text-n-3/50">{email}</div>
            </div>
